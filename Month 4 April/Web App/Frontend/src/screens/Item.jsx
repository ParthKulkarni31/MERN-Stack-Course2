...
function Item() {
  ...
  const [itemName, setItemName] = useState();     // hook- useState hook
  ...
  const handleDelete = async () => {
    try {
      console.log(_id, "_id ==>");
      const apiResponse = await axios.delete(`${import.meta.env.VITE_API_URL_BACKEND}/delete-item/${_id}`);
      setShow(false);
      console.log(apiResponse);
      getAllItemsData();
    } catch (error) {
      ...
      <div className='container'>
        <div className='row'>
          ...
          <div className="col-md-6">
            <h3 className='border text-center'> Create Items </h3>
